...
const Comment = () => {
  return (
    <div className={style.comment}>
        <p>Присутствует встроеная реклама.
Данную рекламу встраивают релиз-группы, а не наш сайт. Мы не несем никакой ответственности за ее содержание.
Вы можете посмотреть сейчас с рекламой, либо дождаться лицензии и смотреть уже без рекламы.</p>
      <div className={style.coms}>
          <input type='text' placeholder='Гость'/><br/>
